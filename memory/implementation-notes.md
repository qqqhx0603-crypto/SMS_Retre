...
- 2026-06-30: v0.3.0 adds `READ_SMS` for recent inbox fallback scanning because vivo/OriginOS may not broadcast some verification messages such as Xianyu. Scanner records `last_inbox_scan_at`, scans at most the recent 30 minutes, and deduplicates against queued SMS by sender/body/time window.
- 2026-06-30: battery alert threshold changed from 5% to 10%.

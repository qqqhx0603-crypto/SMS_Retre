...
- 2026-06-30: v0.4.3 adds a first-run in-app warning dialog and an always-visible usage tutorial in MainActivity. README now has a prominent warning that vivo/OriginOS verification-code safety/privacy protection must be disabled for verification-code forwarding.
